      ...
      <div className="text-center z-10 px-6">
        ...
        >
          <h1 className="text-6xl md:text-9xl font-black mb-6 tracking-tight">
            ...
            <br />
            <span className="text-white">Creativity Awaits</span>
          </h1>

          <p className="text-xl text-gray-400 mb-8 max-w-3xl mx-auto leading-relaxed">
            Transform Your Visuals with AI Magic.
            Effortlessly crop, scale, fine-tune hues, erase backgrounds, and elevate your images using state-of-the-art tech.
